<?php
/*
Template Name: Страница заявки на презентацию
*/
?>
...
if(isset($_POST['submitted'])) {
    ...
    <div class="request request--presentation">
        <div class="request__container container">
            ...
            <div class="request__subscribe subscribe">
                ...
                <?php else : ?>
                    <h2 class="subscribe__title"><?=get_the_title(); ?></h2>
                    ...
                    <form action="<?php the_permalink(); ?>" method="post">
                        ...
                        <label>
                            ...
                            <?php else : ?>
                                <span class="span-label">Контактный телефон c WhatsApp</span>
                            <?php endif; ?>
                        </label>
                        <p class="subscribe__policy">мы свяжемся с вами, чтобы согласовать удобное для вас время для презентации</p>
