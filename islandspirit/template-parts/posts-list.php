    ...
    <section class="posts">
        ...
        <ul class="posts__list">
            <?php while($q->have_posts()) : $q->the_post(); ?>
                ...
                <li class="posts__item entry" itemprop="articleSection">
                    <div class="entry__left share">
                        ...
                        <div class="share__item">
                            <a class="share__link" href="https://www.linkedin.com/cws/share?url=<?=get_the_permalink() ?>" target="_blank">
                        ...
                        <div class="share__item">
                            <a class="share__link" href="http://www.facebook.com/sharer/sharer.php?s=100&p%5Btitle%5D=<?=get_the_title() ?>&p%5Bsummary%5D=<?=get_the_excerpt() ?>&p%5Burl%5D=<?=get_the_permalink() ?>&p%5Bimages%5D%5B0%5D=<?=get_the_post_thumbnail_url( $post->ID, array(846, 470) ); ?>">
                        ...
                        <div class="share__item">
                            <a class="share__link" href="https://vk.com/share.php?url=<?=get_the_permalink() ?>" target="_blank">
                    ...
                    <div class="entry__main">
                        ...
                        <div class="entry__right">
                            <div class="entry__info">
                                <?php if (get_field('author')) : ?>
                                    <div class="entry__info-block">
                                        ...
                                        <p class="entry__info-text" itemprop="author">
                                            <?=get_field('author') ?>
                                        </p>
                                    </div>
                                <?php endif; ?>
                            ...
                            <h3 class="entry__title" itemprop="headline">
                                <a href="<?=get_the_permalink() ?>" itemprop="url">
                                    <?=get_the_title(); ?>
                                </a>
                            </h3>
                            <p class="entry__desc" itemprop="description">
                                <?=get_the_excerpt() ?>
                            </p>
                            <div class="entry__bottom">
                                ...
                                <a class="entry__link" href="<?=get_the_permalink() ?>" itemprop="url">
                                    Читать дальше
        ...
        <div class="posts__pagination container">
            <?php if(function_exists('kama_pagenavi')) kama_pagenavi($before = '', $after = '', $echo = true, $args = array(), $wp_query = $q); ?>
        </div>
